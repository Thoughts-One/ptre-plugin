...
class Ptre_Functions {
    ...
    private function define_public_hooks() {
        ...
        $this->loader->add_action( 'init', $plugin_blocks, 'register_blocks' ); // Register standard blocks on init hook
        $this->loader->add_action( 'acf/init', $plugin_blocks, 'register_acf_blocks', 20 ); // Register ACF blocks on ACF init hook as recommended, with later priority
